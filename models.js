...
class Model {
    ...
    //6.18备注：一般就是静态方法和原型方法（也就是类方法）两种，静态方法是加static关键字的，
    //没加的话就是原型方法
    ...
    static all() {
        // 先获取文件路径
        const path = this.dbPath()   //此处等于是model.dbPath();
        // 打开文件, 获取数据
...
class User extends Model {
    ...
    // 校验登录的逻辑
    validateLogin() {
        log('检查登陆逻辑',this, this.username, this.password)
